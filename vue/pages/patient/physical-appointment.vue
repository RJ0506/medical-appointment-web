            ...
            <form @submit.prevent="handleSubmit">
                ...
                >
                    ...
                    <div>
                        ...
                        <div class="mt-5 flex flex-col font-bold">
                        ...
                        <div class="mt-2 text-center font-bold">
                            ...
                            <span
                                ...
                                examination and authorize the healthcare
                                provider to perform the necessary examination
                                and provide a report
                            </span>
                            <div class="mt-5 flex justify-center gap-2">
                                <input
                                    type="checkbox"
                                    v-model="formData.isAuthorized"
                                />
                                <label for="isAuthorized">I Agree</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div v-if="!isAdding" class="mt-5 flex justify-center">
                    <button
                        :disabled="!formData.isAuthorized"
                        :class="{
                            'cursor-not-allowed bg-gray-400 text-gray-700': !formData.isAuthorized,
                            'hover:bg-emerald-800 bg-[#1e3d2c]': formData.isAuthorized,
                        }"
                        class="rounded px-10 py-1 text-white "
                    >
                        Submit
                    </button>
                </div>
